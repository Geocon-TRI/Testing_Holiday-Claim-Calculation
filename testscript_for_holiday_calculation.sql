...
VALUES 
	 ('192.168.1.14', '7047_JH2', 21309, 2024, 0, 16.5, '[SQL-31780]')
	,('192.168.1.14', '7047_JH2', 4211, 2024, 0, 33.0, '[SQL-31782]')
	,('192.168.1.14', '7047_JH2', 3758, 2024, 0, 32.0, '[SQL-31780]')
	,('192.168.1.14', '127100_GeoconPro_3877', 4680, 2024, 0, 16.0, '[SQL-31780 + SQL-31818], Mindestanspruch OK mit neuer DP_RECALCS_updOtpClaim_p6_SQL31818.sql (06.08./16.43 Uhr)')
	,('192.168.1.14', '127100_GeoconPro_3877', 4596, 2024, 0, 4.0, '[SQL-31780]')
	,('192.168.1.14', '127100_GeoconPro_3877', 4667, 2024, 0, 20.0, '[SQL-31780 + SQL-31818], Mindestanspruch OK mit neuer DP_RECALCS_updOtpClaim_p6_SQL31818.sql (06.08./16.43 Uhr)')
	,('192.168.1.14', '7047_JH2', 6096, 2024, 0, 22.0, '[SQL-31780]')
	,('192.168.1.14', '7047_JH2', 17483, 2024, 0, 27.5, '[SQL-31780]')
	,('192.168.1.14', '7047_JH2', 16853, 2024, 0, 25.0, '[SQL-31780]')
	...
	,('192.168.1.14', '7047_JH2', 2122, 2023, 0, 27.5, '[SQL-30675]')
	,('192.168.1.14', '7047_JH2', 12768, 2023, 0, 5.5, '[SQL-30646]')
	,('192.168.1.14', '7047_JH2', 12768, 2024, 0, 11.0, '[SQL-30646]')
	...
	,('192.168.1.14', '7047_JH2', 18406, 2024, 0, 22.50, 'Bsp. wg. 2x AZ-Historie')
	,('192.168.1.14', '127100_GeoconPro_3877', 4456, 2024, 0, 25.0, '[SQL-31248]')
	,('192.168.1.14', '127100_GeoconPro_3877', 4781, 2024, 0, 5.0, 'tbd')
	,('192.168.1.14', '7047_JH2', 17760, 2024, 0, 26.6, '[SQL-31589] original example')
	,('192.168.1.14', '7047_JH2', 9770, 2024, 0, 13.8, '[SQL-31589] change of occupation 1')
	,('192.168.1.14', '7047_JH2', 8157, 2024, 0, 11.8, '[SQL-31589] change of occupation 2')
	,('192.168.1.14', '7047_JH2', 3530, 2024, 0, 15.0, 'Wiedereintritt im aktuellen Jahr nach Austritt im letzen Jahr')
	,('192.168.1.14', '7047_JH2', 7714, 2024, 0, 19.3, 'Aus- und Wiedereintritt im selben Jahr')
	,('192.168.1.14', '7047_JH2', 13470, 2024, 0, 11.0, 'Austritt im aktuellen Jahr, Wiedereintritt im nächsten Jahr')
	,('192.168.1.14', '7047_JH2', 7935, 2024, 0, 13.8, 'zwei Aus- und Wiedereintritt im selben Jahr')
	,('192.168.1.14', '7047_JH2', 8052, 2024, 0, 8.30, '[SQL-31989] longe leave - false count of full month in long leave 1')
	,('192.168.1.14', '7047_JH2', 8113, 2024, 0, 2.80, '[SQL-31989] longe leave - false count of full month in long leave 2')
	,('192.168.1.14', '7047_JH2', 8218, 2024, 0, 5.50, '[SQL-31989] longe leave - false count of full month in long leave 3')
	,('192.168.1.14', '7047_JH2', 5035, 2024, 0, 24.80, '[SQL-31989] longe leave - false count of full month in long leave 4')
	,('192.168.1.14', '7047_JH2', 7697, 2024, 0, 22.0, '[SQL-31989] longe leave - false count of full month in long leave 5')
